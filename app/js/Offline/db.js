(function (window, undefined) {
        ...
        this.add = function (table) {
            ...
            records.forEach(function (record) {
                ...
                req.onsuccess = function (e) {
                    var target = e.target;
                    //console.log(record.AssessmentID + "added with index " + ++i);
                ...
                req.onerror = function (e) {
                    //console.log(" Error occured in "+record.AssessmentID);
                };
            });
    ...
    var open = function (e, server, version, schema) {
        ...
        console.log('Open method Declaration - COMPLETED');
    };
    ...
    var db = {
        ...
        open: function (options) {
            ...
            //console.log(request + 'DB Open method Initiated - COMPLETED');
            return deferred.promise();
        }
    };
