...
angular.module('SFSiteVisitApp', ['ui.bootstrap', 'velocity.ui', 'ngAnimate', 'ngRoute', 'treasure-overlay-spinner', 'ui.filters']); //, 'colorpicker.module']);
...
angular.module('SFSiteVisitApp').directive('fieldsDirective', ['$http', '$compile', '$timeout', function ($http, $compile, $timeout) {
...
//angular.module('SFSiteVisitApp').run(['security', function (security) {
...
//angular.module('SFSiteVisitApp').config(['$httpProvider', function ($httpProvider) {
//    //initialize get if not there
//    if (!$httpProvider.defaults.headers.get) {
//        $httpProvider.defaults.headers.get = {};
//    }
